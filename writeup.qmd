...
ggplot(killings_summary, aes(x = "", y = count, fill = killing_group)) +
  ...
  coord_polar("y") +
  theme_void() +
  labs(title = "Distribution of Drug-Related Killings per Barangay", fill = "Number of drug-related killings") +
...
ggplot(ioc_long, aes(x = Model, y = Value, fill = Type)) +
  ...
  labs(title = "In-Sample vs. Out-of-Sample Mean Squared Error by Model",
